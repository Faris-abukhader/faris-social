...
DB_CONTAINER_NAME="faris-app-dir-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=faris-app-dir -d -p 5432:5432 docker.io/postgres
